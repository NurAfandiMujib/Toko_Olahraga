...
namespace Toko_Olahraga.Controllers
{
    public class TransaksisController : Controller
    {
        ...
        public TransaksisController(Kelompok5Context context)
        {
            _context = context;
        }
        ...
        {
            var kelompok5Context = _context.Transaksi.Include(t => t.IdBarangNavigation).Include(t => t.IdPembeliNavigation);
